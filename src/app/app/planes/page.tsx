...
export default function PlansPage() {
  ...
  return <div className="mx-auto max-w-3xl px-5 py-16 text-center lg:px-8">
    ...
    <p className="mx-auto mt-4 max-w-2xl text-[13px] leading-7 text-ink-soft">Durante esta fase no necesitas comprar ni elegir una licencia. Inicia un expediente y utiliza las funciones particulares y profesionales con tu cuenta.</p>
