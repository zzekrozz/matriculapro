...
export default function PlantillasPage() {
  return (
    <ModuleGate
      requiresFounder
      moduleName="Plantillas para ITV"
      moduleCode="M.10"
      description="5 emails listos para pedir cita en la ITV, hacer consultas previas, aclarar defectos y solicitar segunda inspección."
      icon={Mail}
    >
      <PlantillasContent />
    </ModuleGate>
