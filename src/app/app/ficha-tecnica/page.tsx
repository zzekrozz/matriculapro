...
import { ChevronLeft, X, Lock, Sparkles, AlertTriangle } from 'lucide-react';
      ...
      <div className="px-5 lg:px-8 pt-6 pb-12 max-w-[1100px] mx-auto">
        ...
        <div className="mb-7">
          ...
          <p className="mt-3 max-w-[640px] text-[14px] leading-relaxed text-ink-soft">
            Aprende a leer una ficha técnica europea sin tener que memorizar los códigos. Mueve el ratón para inclinar el documento, púlsalo para girarlo, y haz clic en cualquier campo para entender qué significa y por qué es importante.
          </p>
        </div>
            ...
            {selectedField && selectedData && (
              ...
              >
                ...
                <div className="mt-3 pt-3 border-t border-line flex items-baseline gap-2">
                  <span className="text-[10px] tracking-[0.18em] uppercase text-muted">Valor en esta ficha</span>
