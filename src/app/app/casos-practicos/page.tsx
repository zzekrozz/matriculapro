    ...
    <div className="min-h-screen bg-bg">
      <div className="px-5 lg:px-8 pt-6 pb-12 max-w-[1280px] mx-auto">
        ...
        <div className="mb-7 flex items-end justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="mt-3 max-w-[640px] text-[14px] leading-relaxed text-ink-soft">
              5 escenarios reales para poner a prueba lo que has aprendido. Cada caso plantea una historia de matriculación con sus documentos, decisiones a tomar y consecuencias. Aprende identificando qué hacer y qué evitar.
            </p>
          </div>
          ...
          {PRACTICAL_CASES.map(c => {
            ...
            return (
              <Link key={c.id} href={`/app/casos-practicos/${c.id}`}
                ...
                {/* Bandera grande de fondo */}
                <div className="absolute top-4 right-4 text-[48px] opacity-20 leading-none select-none pointer-events-none">
                  {c.flag}
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] text-muted">
                      {c.decisions.length} decisiones · {c.documents.length} documentos
                    </span>
        ...
        <div className="mt-8 rounded-xl p-4 flex items-start gap-3 text-[11.5px] leading-relaxed bg-warn-soft text-warn border border-accent-soft">
          ...
          <span>
            Los casos son simulaciones formativas. Los nombres de marcas y modelos se usan con fines didácticos. Las situaciones reales pueden incluir matices adicionales — ante dudas, consulta con gestoría, ingeniero o asesor fiscal.
          </span>
        </div>
      </div>
    </div>
