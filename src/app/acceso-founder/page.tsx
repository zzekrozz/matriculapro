...
import { Crown, CheckCircle2, UserPlus, LogIn, Loader2, AlertCircle } from 'lucide-react';
...
function AccesoFounderContent() {
  ...
  return (
    <div className="w-full max-w-[560px]">
      ...
      >
        <div
          className="p-5 sm:p-7 lg:p-8 text-center relative overflow-hidden"
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="text-[10px] tracking-[0.22em] uppercase mb-1 text-accent font-semibold">
              {success ? 'Pago completado' : 'Activación Founder'}
            </div>
            <h1 className="font-serif italic leading-[1.05] tracking-tight mb-2" style={{ fontSize: 'clamp(20px, 2.8vw, 28px)' }}>
              {success ? 'Pago completado. Ahora activa tu acceso.' : 'Activa tu acceso Founder Alpha'}
            </h1>
            <p className="text-[13px] leading-relaxed max-w-[420px] mx-auto" style={{ color: 'rgba(255,255,255,0.72)' }}>
              Usa exactamente el mismo email que utilizaste en Stripe para que el sistema pueda vincular tu compra.
            </p>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-7 lg:p-8 flex flex-col gap-3">
          <Link
            href="/auth/register?from=acceso-founder"
          ...
          <p className="text-center text-[11px] text-muted leading-relaxed pt-1">
            Si todavía no has pagado, revisa primero la sección de precios y el acceso Founder Alpha.
          </p>
          <a
            href="/#precios"
            className="text-center text-[12px] text-accent-deep hover:text-ink transition-colors"
          >
            Ver precios Founder
          </a>
        </div>
