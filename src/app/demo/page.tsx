...
import { ChevronLeft, Sparkles, ChevronRight, Play } from 'lucide-react';
      ...
      <header className="sticky top-0 z-30 bg-surface/85 backdrop-blur border-b border-line">
        <div className="max-w-[1400px] mx-auto px-5 lg:px-8 h-[60px] flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-[12.5px] text-muted hover:text-ink">
            <ChevronLeft size={14} /> Volver a la landing
          </Link>
          ...
          <Link href="/app/dashboard"
            ...
            Comprar curso · 89&nbsp;€ <ChevronRight size={12} />
          </Link>
        </div>
      </header>
        ...
        <div className="max-w-[1400px] mx-auto px-5 lg:px-8 py-3 flex items-center justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-2 text-[12.5px]">
            ...
            <span className="text-muted-soft">
              Estás probando la demo. Ves los primeros <strong className="text-white">5 pasos</strong> del recorrido ITV. El curso completo incluye los 11 pasos + el simulador 576 completo + la ficha técnica 3D + checklists + casos prácticos.
            </span>
          </div>
          <Link href="/app/dashboard" className="text-[11.5px] inline-flex items-center gap-1 text-accent hover:underline whitespace-nowrap">
            Ver curso completo <ChevronRight size={11} />
          </Link>
        </div>
      </div>
          ...
          <div className="relative grid lg:grid-cols-[1.4fr_auto] gap-6 items-center">
            <div>
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full mb-3 bg-accent/20 text-accent">
                <Sparkles size={11} />
                <span className="text-[10.5px] tracking-[0.18em] uppercase font-semibold">Preventa abierta</span>
              </div>
              ...
              <p className="mt-3 max-w-[560px] text-[14px] text-muted-soft leading-relaxed">
                89 € en preventa, pago único. Acceso permanente, actualizaciones gratuitas, cupón del 20% para futuros cursos. Después subirá a 129 €.
              </p>
              <div className="mt-2 flex items-baseline gap-2 text-muted-soft">
                <span className="text-[12px] line-through">129 €</span>
                <span className="font-serif italic text-white text-[28px] leading-none">89 €</span>
                <span className="text-[10px]">pago único</span>
              </div>
            </div>
            <div className="flex flex-col gap-2 shrink-0">
              <Link href="/app/dashboard"
                ...
                Comprar curso completo <ChevronRight size={14} />
              </Link>
