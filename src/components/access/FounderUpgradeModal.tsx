              ...
              {phase === 'pitch' && (
                <motion.div key="pitch"
                  ...
                  <ul className="space-y-2.5 mb-6">
                    {[
                      { icon: Sparkles, text: 'Acceso completo a todo lo construido hasta ahora: ruta, simulador 576, ficha técnica 3D, recorrido ITV, checklists, casos prácticos, biblioteca, plantillas.' },
