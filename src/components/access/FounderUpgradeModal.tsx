            ...
            <AnimatePresence mode="wait">
              {phase === 'pitch' && (
                ...
                >
                  ...
                  >
                    Accede antes y mantén tu plaza aunque MatriculaPRO suba de precio.
                  </h2>

                  <p className="text-[14px] leading-relaxed text-ink-soft mb-5">
                    MatriculaPRO está en beta. Los primeros usuarios conservan el <strong className="text-ink">acceso de por vida</strong> a todo lo que se construya después.
                  </p>
                  ...
                  <div className="rounded-2xl p-5 mb-5 bg-bg-deep border border-line">
                    ...
                    <p className="text-[12.5px] text-ink-soft italic">
                      Entras ahora con precio beta y mantienes el acceso aunque el precio suba más adelante.
                    </p>
                  </div>
                  ...
                  <ul className="space-y-2.5 mb-6">
                    {[
                      { icon: Sparkles, text: 'Acceso completo: ruta, simulador 576, ficha técnica 3D, recorrido ITV, checklists, casos prácticos, biblioteca y plantillas.' },
                      ...
                      { icon: Heart, text: 'Tu feedback durante la beta ayuda a mejorar el producto real.' },
                  ...
                  >
                    ...
                    Comprar acceso Founder · 49 € <ChevronRight size={14} />
                  </button>
              ...
              {phase === 'welcome' && (
                ...
                >
                  ...
                  <h2
                    className="font-serif text-ink leading-[1.05] tracking-tight mb-2"
                    style={{ fontSize: 'clamp(26px, 3.2vw, 36px)' }}
                  >
                    Eres <span className="italic text-accent">Founder {formatFounderNumber(assignedNumber ?? existingNumber ?? 2)}</span>
                  </h2>
                  ...
                  <div className="rounded-2xl p-5 mb-6 bg-bg-deep border border-line text-left">
                    ...
                    <ul className="space-y-1.5">
                      {[
                        ...
                        'Simulador 576, ficha técnica 3D y recorrido ITV completo',
                        'Casos prácticos, checklists, biblioteca y plantillas',
                        'Progreso guardado y badge Founder en el sidebar',
                      ].map((t, i) => (
