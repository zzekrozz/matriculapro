      ...
      <div className="flex-1 px-6 py-5 space-y-2.5 overflow-y-auto">
        ...
        <div className="mt-3 rounded-xl p-3.5 flex items-start gap-3"
          ...
          <div className="text-[11.5px] leading-relaxed" style={{ color: tokens.color.inkSoft }}>
            <strong style={{ color: tokens.color.ink }}>En la versión completa</strong> podrás practicar con fichas aleatorias, casos por dificultad (fácil, medio, alerta) y corrección paso a paso de los 10 campos.
          </div>
        </div>
      </div>
